...
import com.example.myapplication.OrganizerProfileActivity;
...
public class OrganizerProfileView extends BaseActivity {
    ...
    private void setListeners() {
        ...
        myEvents.setOnClickListener(v -> myEvents());
    }
    ...
    private void myEvents() {
        Intent intent = new Intent(OrganizerProfileView.this, HomeView.class);
